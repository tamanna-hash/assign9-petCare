...
const Expert = ({expert}) => {
    ...
    return (
        <div>
            <div className="card md:h-[320px]  rounded-4xl bg-[#f6f9ff] shadow-sm hover:scale-103 p-1 md:p-2 1s ease-in-out ">
                <figure>
                    <img className='h-[50px] w-[50px] md:h-[90px] md:w-[90px] rounded-[50%] object-cover'
                        src={image}
                        alt="experts" />
                </figure>
                <div className="card-body ">
                    <div className='flex-1 flex flex-col justify-center items-start md:gap-2 '>
                        <h2 className="card-title text-center text-slate-600">{name}</h2>
                        <p className='text-gray-500 wrap-break-word whitespace-normal'>Email: {email}</p>
